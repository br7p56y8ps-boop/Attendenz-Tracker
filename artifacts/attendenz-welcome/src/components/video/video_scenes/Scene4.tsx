...
export function Scene4() {
  ...
  useEffect(() => {
    // Scene 4 total duration is 3000ms. Begin smooth exit at 2400ms.
  ...
  return (
    ...
    >
      {/* Transparent radial vignette - keeps background particles visible */}
      <div
      ...
      <motion.div
        ...
        animate={
          phase === 'exit'
            ? { opacity: 0, scale: 0.94, filter: 'blur(8px)', y: -10 }
            : { opacity: 1, scale: 1, filter: 'blur(0px)', y: 0 }
        }
        transition={{ duration: 0.6, ease: 'easeInOut' }}
      >
        {/* Logo Entrance with pulsing glow ring */}
        <div className="relative mb-2">
          ...
          >
            <img
              src={logoImg}
              alt="Attendenz Logo"
              className="w-full h-full object-contain filter drop-shadow-[0_0_12px_rgba(59,130,246,0.8)]"
              onError={(e) => {

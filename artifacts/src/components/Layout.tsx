    ...
    >
      ...
      <motion.div
        ...
        className={cn(
          ...
          'bottom-nav-surface bg-card/90 backdrop-blur-xl overflow-hidden border-x-0 border-b-0 border-t border-black/20 dark:border-white/20 rounded-t-[28px] pt-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] px-3 shadow-[0_-16px_40px_rgba(0,0,0,0.25)] z-40',

        ...
        <section
          ...
          {section === 'clinical' && (
            <div className="flex h-0 min-h-0 flex-1 flex-col">
              <div className="relative z-0 h-0 min-h-0 flex-1 overflow-y-auto overscroll-contain !bg-transparent space-y-2 border border-dashed border-border/80 px-4 py-3" style={{ overscrollBehaviorY: 'contain' }}>

...
/* ── Update notice (amber pill in app-bar row) ── */
...
// Round-1 guard preserved: custom subjects only ever render in custom mode
...
/* ── A1 · Unified day card list, sorted by parsed start minutes (wards included) ── */
...
/* ── Small Group Teaching: clinical-type, ONE card per day inside its placement duration ── */
if (subjectMode === 'preloaded') {
...
className="relative w-128 h-28 mb-4"
>
...
className="text-6xl"
>
<MoonStar className="w-16 h-16 text-primary" />
</motion.span>
<motion.div
...
{/* A1 · All day cards (wards included) rendered in start-time order */}
...
{/* ── Back to Today (small, light-transparent, clear of nav bar) ── */}
<AnimatePresence>
{!isTodaySelected && (
<motion.div
...
{/* ── Update notice modal: short summary + how-to ── */}
<AnimatePresence>
{updateInfoOpen && (
